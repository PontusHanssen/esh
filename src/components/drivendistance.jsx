...
export default class DrivenDistance extends Component {
  render() {
    ...
    return (
      <Col s={12} m={12} l={8}>
        <Card className={'card2 distance-card'} style={{background: "#82ca9d"}}actions={[<a href='#'>Previous week</a>, <span className={"pull-right"}><a href='#'>Next week</a></span>]} title="Driven Distance">
